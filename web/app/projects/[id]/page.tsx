...
const DashboardPage: React.FC = () => {
  ...
  return (
    <div className="mx-auto max-w-[1400px] w-full flex flex-col gap-4">
      {/* Back button */}
      <Link
        href="/projects"
      ...
      <div className="flex flex-1 gap-8">
        ...
        <div className="flex flex-col gap-4 w-5/12 overflow-y-auto">
          {/* Title + Search */}
        ...
        {/* Right column (wider, taller preview) */}

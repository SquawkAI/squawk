...
const SAMPLE_PROJECTS: Project[] = [
  {
    id: '1',
    name: 'ECEN 314 Virtual TA',
    description: 'A virtual teaching assistant for ECEN 314 (Signals & Systems)',
    lastOpened: '2 hours ago',
  },
  { id: '2', name: 'ECEN 314 Virtual TA', description: 'A virtual teaching assistant for ECEN 314 (Signals & Systems)', lastOpened: '2 hours ago' },
  { id: '3', name: 'ECEN 314 Virtual TA', description: 'A virtual teaching assistant for ECEN 314 (Signals & Systems)', lastOpened: '2 hours ago' },
  { id: '4', name: 'ECEN 314 Virtual TA', description: 'A virtual teaching assistant for ECEN 314 (Signals & Systems)', lastOpened: '2 hours ago' },
];
...
const ProjectsPage: React.FC = () => {
  ...
  const filteredProjects = useMemo(() => {
    ...
    return q
      ? SAMPLE_PROJECTS.filter(p => p.name.toLowerCase().includes(q))
      : SAMPLE_PROJECTS;
  }, [query]);
          ...
          {recent.map(p => (
            ...
            >
              ...
              <div className="mt-4 flex items-center gap-1 text-xs text-gray-500">
                ...
                <span>Last opened {p.lastOpened}</span>
              </div>
            </div>
          ))}
        </div>
          ...
          {filteredProjects.map(p => (
            ...
            >
              <div className="flex items-center gap-4">
                {/* <Cube className="h-8 w-8 text-gray-500" strokeWidth={1.5} /> */}
                <div>
